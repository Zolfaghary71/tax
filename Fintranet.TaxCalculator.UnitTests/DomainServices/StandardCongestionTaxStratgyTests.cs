...
namespace Fintranet.TaxCalculator.UnitTests.DomainServices;
...
public class StandardCongestionTaxStratgyTests
{
    ...
    public void CalculateDailyTaxAsync_ShouldSetTaxToZero_ForExemptVehicle()
    {
        ...
        var result = _strategy.CalculateDailyTax(passes);
    ...
    public void CalculateDailyTaxAsync_ShouldThrowException_ForDifferentDates()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => _strategy.CalculateDailyTax(passes));
    }
    ...
    public void CalculateDailyTaxAsync_ShouldCalculateCorrectTax_ForGroupedByDay()
    {
        ...
        {
            var result = _strategy.CalculateDailyTax(group.ToList());
